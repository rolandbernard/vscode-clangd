    ...
    const clientOptions: vscodelc.LanguageClientOptions = {
      ...
      middleware: {
        ...
        provideDocumentSemanticTokens: async (document, token, next) => {
          ...
          if (result) {
            return inactiveRegions.provideDocumentSemanticTokens(document, result);
          } else {
            return result;
          }
        },
        provideDocumentSemanticTokensEdits: async (document, previousResultId, token, next) => {
          ...
          if (result) {
            return inactiveRegions.provideDocumentSemanticTokensEdits(document, previousResultId, result);
          } else {
            return result;
          }
        }
